...
# = Node('Severity', name=data[i][6])
    ...
    graph.create(attr16)
    # Rel1 = Relationship(node, 'Product', attr1,name = 'Product')
    # Rel2 = Relationship(node, 'Component', attr2,name = 'Component')
    # Rel3 = Relationship(node, 'Type', attr3,name = 'Type')
    # Rel4 = Relationship(node, 'Priority', attr4,name = )
    ...
    Rel1 = Relationship(node, 'Product', attr1,name = 'Product')
    Rel3 = Relationship(node, 'Type', attr3,name = 'Type')
    Rel4 = Relationship(node, 'Priority', attr4,name = 'Priority')
    Rel5 = Relationship(node, 'Severity', attr5,name = 'Severity')
    Rel6 = Relationship(node, 'Status', attr6,name = 'Status')
